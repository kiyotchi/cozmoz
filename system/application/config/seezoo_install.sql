...
CREATE TABLE IF NOT EXISTS `block_permissions` (
  ...
  `allow_mobile_carrier` varchar(60) default NULL,
...
CREATE TABLE IF NOT EXISTS `sz_bt_forms` (
  ...
  `auto_reply_mailbody` text,
  `auto_reply_mail_subject` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`block_id`)
) DEFAULT CHARSET=utf8;
...
-- (48, 1, 0, 0, 0, '0000-00-00 00:00:00'),
-- (49, 1, 0, 0, 0, '0000-00-00 00:00:00');
...
(29, 'dashboard/blocks/draft_blocks', 29),
(30, 'blog', 30),
...
(45, 'profile', 45),
(46, 'dashboard/blocks/block_list', 46),
(47, 'dashboard/blocks/block_set', 47);
-- (48, 'dashboard/plugins', 46),
-- (49, 'dashboard/plugins/plugin_list', 47);
...
(29, 1, 29, '下書き/共有管理', 0, '0', '', '', 1, 13, 2, 1, NOW(), 1, 1, NOW(), 1, NULL, 1, 0, 0, ''),
...
(46, 1, 46, '一般ブロック管理', 0, '0', '', '', 1, 13, 1, 1, NOW(), 1, 1, NOW(), 1, NULL, 1, 0, 0, ''),
(47, 1, 47, 'ブロックセット管理', 0, '0', '', '', 1, 13, 3, 1, NOW(), 1, 1, NOW(), 1, NULL, 1, 0, 0, '');
-- (48, 1, 48, 'プラグイン管理', 0, '0', '', '', 1, 0, 15, 0, NOW(), 1, 1, NOW(), 1, NULL, 1, 0, 0, ''),
-- (49, 1, 49, 'プラグイン一覧', 0, '0', '', '', 1, 46, 1, 1, NOW(), 1, 1, NOW(), 1, NULL, 1, 0, 0, '');
...
CREATE TABLE IF NOT EXISTS `site_info` (
  ...
  `debug_level` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'デバッグレベル',
...
CREATE TABLE IF NOT EXISTS `sz_blog` (
  ...
  `show_datetime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '公開日時',
  `permalink` varchar(255) DEFAULT NULL COMMENT 'パーマリンク',
...
CREATE TABLE IF NOT EXISTS `sz_blog_category` (
  ...
  `display_order` int(4) NOT NULL DEFAULT '0' COMMENT '並び順',
...
INSERT INTO `page_permissions` (`page_id`, `allow_access_user`, `allow_edit_user`, `allow_approve_user`) VALUES (1, ':0:m:', '', ''), (30, ':0:m:', '', ''), (39, ':0:m:', '', ''), (40, ':0:m:', '', ''), (45, ':0:m:', '', '');
...
CREATE TABLE IF NOT EXISTS `block_set_data` (
  ...
  `ct_handle` VARCHAR( 255 ) NOT NULL DEFAULT  '' COMMENT  'カスタムテンプレートハンドル',
...
-- OGP data
INSERT INTO `sz_ogp_data` (`is_enable`, `site_type`, `file_id`, `extra`) VALUES
(0, 'website', 0, '');
