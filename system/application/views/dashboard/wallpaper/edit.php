...
<div id="main">
  ...
  <?php echo form_open_multipart('dashboard/wallpaper/edit/confirm', array('class' => 'jNice', 'id' => 'entry_form'))?>
  <fieldset>
    <p>
      <label>メーカー</label>
    ...
    <p>
      <label>壁紙イメージ（自動変換され、サムネール画像でも指定します。）</label>
    ...
    <?php echo form_hidden('tmp_wall_cal_dat_id', isset($entry->wall_cal_dat_id) ? $entry->wall_cal_dat_id : $tmp_wall_cal_dat_id);?>
