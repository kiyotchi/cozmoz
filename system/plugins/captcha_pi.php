...
{		
	$defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '150', 'img_height' => '30', 'font_path' => '', 'expiration' => 7200, 'font_size' => 15);		
   ...
   if ($word == '')
   {
	...
	//$bg_color		= imagecolorallocate ($im, 204, 238, 238);
	$border_color	= imagecolorallocate ($im, 153, 102, 102);
	//$border_color	= imagecolorallocate ($im, 16, 238, 26);
	...
	{
		//$font_size	= 16;
		// modified 2010/03/27 by Yoshiaki Sugimoto
		// font_size can set with parameters(default 12)
		//$font_size = 15;
