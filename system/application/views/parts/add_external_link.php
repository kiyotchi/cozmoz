	...
	<table>
		<tbody>
			<tr class="odd">
				...
				<td><?php echo form_input(array('name' => 'external_link', 'class' => 'long-text', 'id' => 'add_external_uri'));?></td>
			</tr>
			<tr>
				<td class="cap">リンクタイトル</td>
				<td><?php echo form_input(array('name' => 'page_title', 'class' => 'long-text', 'id' => 'add_external_title'));?></td>
			</tr>
			<tr class="odd">
				<td class="cap">&nbsp;</td>
				<td>
					<label><?php echo form_checkbox('navigation_show', 1, TRUE);?>&nbsp;ナビゲーションに表示する</label>
				</td>
			</tr>
			<tr>
				<td class="cap">&nbsp;</td>
				<td>
					<label><?php echo form_checkbox('target_blank', 1, FALSE);?>&nbsp;新規タブ（ウインドウで開く）</label>
				</td>
			</tr>
		</tbody>
	</table>
