...
<!--↓mainimg↓-->
<div id="main_img">
	<?php echo $this->load->area('main_img');?>
</div>
<!--↑mainimg↑-->
...
<div class="tl_contents">
	<?php echo $this->load->area('left');?>
</div>
<!--↑leftcontents↑-->


<!--↓centercontents↓-->
<div class="tc_contents">
...
<p id="copyright">Copyright &copy;<?php echo SITE_TITLE;?> All Rights Reserved.</p>
